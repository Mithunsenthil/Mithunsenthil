...
* 🔭 **Currently focusing on:** Deep Learning & Neural Network optimization.
...
| :--- | :--- |
| **Data Science** | `Python` `NumPy` `Pandas` `PyTorch` `TensorFlow` `Scikit-Learn` |
| **Web / Backend** | `Django` `MySQL` `HTML5` `CSS3` |
| **Visualization** | `Power BI` `Matplotlib` `Seaborn` |
| **Tools** | `Git` `VS Code` `Jupyter` `Google Colab` |
| **Creative** | `FL Studio` `Blender` |

---
### 🔗 Let's Connect!
* 💼 **LinkedIn:** [Mithun Senthil V](https://www.linkedin.com/in/mithun-senthil-v-17a2b8258)
* 📧 **Email:** mithunsenthil012@gmail.com
